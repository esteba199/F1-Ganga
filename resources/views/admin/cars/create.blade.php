...
<div class="container animate__animated animate__fadeIn">
    <div class="d-flex justify-content-between align-items-center mb-5">
        <h1 class="display-5 fw-bold text-warning">Crear Nuevo Coche</h1>
    ...
    <div class="card glass border-0 shadow-lg">
        <div class="card-body p-4">
            <form action="{{ route('admin.cars.store') }}" method="POST" enctype="multipart/form-data" novalidate>
                @csrf
                @include('admin.cars._form')
                <div class="d-flex gap-2 mt-4">
                    <button class="btn btn-warning fw-bold px-5 rounded-pill text-dark">
                        <i class="bi bi-check-circle me-2"></i>Guardar Coche
                    </button>
